 ...
 */
export declare class OnlineGuard implements CanActivate, CanActivateChild, CanLoad {
    protected router: Router;
    protected network: Network;
    protected routeOffline: string;
    protected guardsRedirect: boolean;
    constructor(router: Router, network: Network, routeOffline: string, guardsRedirect: boolean);
    canActivate(): boolean;
